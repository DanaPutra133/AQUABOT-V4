...
let handler = async (m, { conn, command }) => {
    let buffer = await fetch(`https://telegra.ph/file/fd7714ee03f6970d8fb30.jpg`).then(res => res.buffer())
...
💰 Harga:
	...
	⁠Source Code dari kamu: Rp20.000
✨ Fitur:
✅ Update Gratis
✅ Service 24/7
✅ Maintenance Gratis
...
💰 Harga:
	⁠Source Code dari saya: Rp28.000
	⁠Source Code dari kamu: Rp50.000
✨ Fitur:
✅ Update Gratis
✅ Service 24/7
✅ Maintenance Gratis
...
💡 4. Paket Unlimited (+ Garansi 6 Bulan)
💰 Harga:
	⁠Source Code dari saya: Rp50.000
	⁠Source Code dari kamu: Rp75.000
✨ Fitur:
✅ Update Gratis
✅ Service 24/7
✅ Maintenance Gratis
