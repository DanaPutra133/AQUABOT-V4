...
*${usedPrefix + command}* 100`.trim()
    ...
    if (apuesta < 100) throw '✳️ tambahkan *XP* Untuk menggunakan lagi'
    if (users.exp < apuesta) {
        throw `✳️ Anda tidak memiliki cukup *XP* jangan lupa untuk *daily!* \n Cek xp mu di *.balance*`
    }
